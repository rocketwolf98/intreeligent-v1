...
def load_maskrcnn(checkpoint_path: str, config: OrthomosaicConfig) -> LitMaskRCNN:
...
def load_autoencoder(checkpoint_path: str, config: OrthomosaicConfig, model_class):
...
def run_detection(model: LitMaskRCNN, image_tensor: torch.Tensor, config: OrthomosaicConfig) -> Dict:
...
def crop_masks(image_np: np.ndarray, predictions: Dict, config: OrthomosaicConfig) -> List[np.ndarray]:
    """
...
def extract_features(autoencoder, crops: List[np.ndarray], config: OrthomosaicConfig) -> np.ndarray:
    """
...
def cluster_features(features: np.ndarray, config: OrthomosaicConfig, params: Dict) -> np.ndarray:
    """
